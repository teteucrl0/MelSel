...
const checkout = (shippingAddress, paymentMethod) => api.post('/api/cart/checkout', { shippingAddress, paymentMethod }).then(r => r.data)

export default { addItem, listCart, removeItem, checkout }
